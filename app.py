...
def makeAttendanceEntry(name):
    with open(r"C:\Users\prath\Downloads\CODING\PROJECT\mainproject\attendance1.csv", 'r+') as FILE:
...
def send_mail():
    body = r"C:\Users\prath\Downloads\CODING\PROJECT\mainproject\attendance1.csv"
    filename = r"C:\Users\prath\Downloads\CODING\PROJECT\mainproject\attendance1.csv"
    column_index = 0
